                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="{{route('gadgets.show',[$asset->id])}}"
                                                   class="dropdown-item"><i
                                                        class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                            </li>
                                            @if($asset->status==='ASSIGNED')
                                                <li><a href="{{route('gadgets.edit',[$asset->id])}}"
                                            ...
                                            @if($asset->status!='DEREGISTERED')
                                                <li><a href="{{route('assets.deregister',[$asset->id])}}"
                                                       class="dropdown-item edit-item-btn text-primary"><i
                                                            class="ri-pencil-fill align-bottom me-2 text-danger"></i>
                                                        Deregister</a></li>
                                            @endif
                                        </ul>
                                    </div>
