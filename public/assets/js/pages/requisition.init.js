...
function isData() {
    var plus = document.getElementsByClassName("plus"), minus = document.getElementsByClassName("minus");
...
function new_link() {
    ...
    var delLink =
        ...
        <th scope="row" class="product-id">-${count}</th>
                                    <td class="text-start">
                                        <div class="mb-2">
                                            <input type="text" class="form-control bg-light border-0" id="productName-${count}" name="names[]" placeholder="Product Name" required />
                                    ...
                                    <td class="text-end">
                                        <div>
                                            <select class="js-example-basic-single"  name="suppliers[]"  >
                                               ${suppliersData}
                                            </select>
                                        </div>
                                    </td>
                                    <td>
                                        <input type="number" class="form-control product-price bg-light border-0" name="prices[]" id="productRate-${count}" step="0.01" placeholder="0.00" required />
                                        <div class="invalid-feedback">
                                    ...
                                    <td>
                                        <div class="input- step">
                                            <input type="text" class="form-control product-quantity bg-light border-0" id="product-qty-${count}" name="quantities[]"  required />
                                        </div>
                                    </td>
...
if ((viewobj != '') && (options == "edit-invoice")) {
    ...
    new Cleave("#compnayContactno", {
        prefix: viewobj.company_details.contact_no, delimiters: ['(', ')', '-'], blocks: [0, 3, 3, 4]
    });
    ...
    var cleave = new Cleave('#cardNumber', {
        prefix: viewobj.payment_details.card_number, delimiter: ' ', blocks: [4, 4, 4, 4], uppercase: true
    });
